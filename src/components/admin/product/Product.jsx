...
const Product = () => {
    ...
    const deleteProduct = async (id) => {
        try {
            const res = await fetch(`${apiUrl}/admin/products/delete/${id}`, {
                method: 'DELETE',
                headers: {
                    ...
                    <div className='col-lg-9'>
                        <div className="row">
                            <div className='col-xl-12 d-flex justify-content-end mb-3'>
                                <Link to={'/admin/products/create'} className='btn btn-info text-white'>Create</Link>
                            </div>
                        </div>
                        <div className='row'>
                                                            ...
                                                            return (
                                                                <tr key={index}>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <button type='button' onClick={() => deleteProduct(product.id)} className='ms-3 text-danger border-0 bg-transparent'>
